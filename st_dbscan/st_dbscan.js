...
function st_dbscan(X, eps1, eps2, MinPts) {
    ...
    var labels = Array.apply(null, Array(X.length)).map(Number.prototype.valueOf,0);  // new an 0 array to store labels, IE capability
    //var labels = new Array(X.length).fill(0); // new an 0 array to store labels, ES6
